...
For the last one, I pulled in a friend who is a serious network architect. I translated the organisation; he designed the network. We stretched the VLANs between sites ourselves — we ended up paying for what a provider would have thrown in, but it got done. Most machines were never powered down at all. The ones people insisted "had to go down because of NFS mounts" didn't: you move the machine live, it runs a bit slow for a while, then you migrate the storage and remount. That's it.
