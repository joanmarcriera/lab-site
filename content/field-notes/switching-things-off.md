...
*Everything here is as it stood when I left; the estate has moved on since under people doing good work, and I have no view of it now.*
...
The piece I most wanted to survive me is the least visible of the lot: virtual accounts. Replacing password-bearing transfer accounts, which belong to the outside world, with passwordless accounts that internal people sudo into — so that when someone leaves, their replacement can sudo in, read the Linux history, and inherit the actual knowledge instead of a mystery. On my last day I was still explaining it. Whether it survived I don't know — I have no view of that estate now, and the people there may well have found a better pattern. The general point stands: an account should carry its history to the next owner, not a password to the outside world.
