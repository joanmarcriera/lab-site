---
title: "The oldest thing I ever switched off"
date: 2026-07-20
tags: [operations]
...
First week into the institution. Before I'd found the good coffee, I found the oldest machine on the network. It was still serving NIS — the old Network Information Service that ypcat talks to — a protocol whose weaknesses had been documented since my university days, twenty years earlier. Nobody needed it. It was still there.

I raised it. It was already known, and already on a list — as these things usually are in any estate that has been running for decades. What was missing was not knowledge. It was somebody whose job it was to switch it off.

That is how I came to own the identity process. Not through a reorg or a job description — through a twenty-year-old protocol that nobody had got round to retiring. ypcat was the first thing I switched off, because nobody needed it in the year 2000, and you certainly don't need it in 2025. (Everything in this post is years old and was dealt with at the time; I have no current view of that estate.) The point of the story isn't the finding. Old services with known weaknesses are ordinary. The point is that switching that machine off was the most useful thing anyone had done to it in a decade, and it had been sitting there the whole time because retiring things is nobody's job until someone decides it's their job.
...
That's the through-line of every one of these. ypcat, the Bash provisioner, XMPP, LSF, Kubernetes-over-FTP, Redis, rsync twice, the S3-write we buried, the actuators I asked for and shouldn't have. Building is easy to be proud of. Switching things off — deciding, with your team and your evidence, what the world is better without — is the harder and quieter half of the job.
