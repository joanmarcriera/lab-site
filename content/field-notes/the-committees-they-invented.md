---
title: "How I learned to make governance work for change"
date: 2026-07-20
tags: [leadership]
aliases: ["/war-stories/the-committees-they-invented/"]
---

There is a kind of organisation that never says no. It asks for a business case instead.

I spent years learning to work with it. I'd push for something concrete — say, procedural change management for hardware, because every time we installed new disks somebody disconnected something that was still live — and the answer would be: "Write a business case. Present it to this group." A group that had recently been created. Whose remit nobody could quite state. That met once every six months. And that, on inspection, wasn't a change board or a decision body at all.

I complied a couple of times before I understood what I was looking at. Not obstruction — I don't think anyone set out to block anything — but an organisation that had grown governance faster than it had grown decisions. A new forum is easy to create and hard to give teeth. Left alone, it becomes a waiting room, and in an institution where everyone's tenure is finite, a waiting room is where ideas quietly expire. The people in the room were not my opponents. The structure was just not built to move.
...
The endgame was quiet: the forums either became real decision bodies or stopped being invoked, and either outcome was fine. It freed me to spend my time where the actual work was — with human resources, on identity, on the things that outlasted all of us.
