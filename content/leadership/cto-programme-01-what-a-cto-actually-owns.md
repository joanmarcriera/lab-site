...
Two things fell out of the exercise. First, relief: I stopped judging my work against a fantasy job description. Platform work is a strategic role, the same way that CTO-as-customisation-police was a strategic role in the case above. Second, a gap became visible: I could describe my stepping stones precisely, but I had never written down, in a form the organisation could endorse, the milestone they were stepping towards. Institutional strategy naturally centred on the research mission; translating that into what technology should deliver was a gap, and one I was well placed to help close rather than wait for. You cannot align to a target that hasn't been named. Spotting that gap — and being able to say it in strategy language rather than as an engineer's complaint — was worth the whole exercise on its own.
