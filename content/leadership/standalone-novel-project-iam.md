---
title: "A decade of identity debt, and how we paid it down"
date: 2026-07-19T18:30:00+01:00
tags: [leadership, operations]
---

Nobody volunteers to replace an identity management system. When I took on the IAM overhaul at the institute, the underlying system had gone without serious attention for well over a decade. The internal consensus was that it would take ten more years to fix, because it could only be done in tiny pieces. Both beliefs were wrong, but understanding *why* they were wrong took a framework I only later found a proper name for.
...
When I sat down and mapped the uncertainties honestly, the table was sobering. Would the business logic even be implementable programmatically? Unknown. Would researchers, who had suffered the old system for years, actually want change? Unknown. Would HR be ready to become the source of truth for identity, and on what timeline? Risk. Would application owners help, or would helping us consume more of our time than doing it alone? Risk. Would the federation partners react badly? Unknown.

One entry in that table deserves a highlight: "Appetite for change in IT management" was the only item I could mark as *known*: cautious, and rightly asking for reassurance before a change of this size. Knowing that was worth more than any architecture diagram, because caution you can plan for; surprises you cannot.
...
**The ten-year estimate was a cultural artefact, not an engineering one.** It priced in how unloved the topic was — years of "not my problem" from every direction — rather than the work. Once someone owned the problem end to end, the work was tractable.

**Undocumented logic is recovered socially, not archaeologically.** We did not reverse-engineer more than a decade of code in isolation. We extracted the rules from people, in rounds, and validated in public. The documentation was a by-product of building consensus.
...
There is a quiet epilogue. When I left, the next layer was already visible: more sign-in and second-factor paths than anyone would design on purpose, each with its own small tax on everyone's week. Paying down one layer of debt exposes the next. That is not failure; that is what progress looks like in infrastructure.

All of this is historical. It describes the environment as it was when I worked on it; it has moved on since, under people doing good work, and I have no current access to it or knowledge of it.
...
- [NIST SP 800-63 Digital Identity Guidelines — the public reference for what disciplined identity management looks like](https://pages.nist.gov/800-63-3/)
